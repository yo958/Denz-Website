...
import { Wifi, UtensilsCrossed, BedDouble, ArrowRight } from 'lucide-react';
...
const FEATURES = [
  {
    ...
    description:
      'Gigabit WiFi, standing desks, meeting rooms and flexible packages from hourly to yearly. Start from just ฿50/hour.',
    href: '/coworking',
    cta: 'View packages',
    accent: 'bg-blue-50',
    iconBg: 'bg-blue-100',
